...
void Fit_Final() {
	...
	float ctau_JJ_Gaus_Mean_Value = 0.00008;
	float ctau_JJ_Gaus_Sigma1_Value = 0.00221;
	float ctau_JJ_Gaus_Sigma2_Value = 0.00593;
	float ctau_JJ_Gaus_Frac_Value = 0.791;

	//For non-prompt J/psi on the ctau dimension
	float ctau_JJ_Convolution_Tau_Value = -26.86;
	float ctau_JJ_Convolution_Mean_Value = 0.00037;
	float ctau_JJ_Convolution_Sigma_Value = 0.00315;

	//For JMuMu on the ctau(J/psi) dimension 
	float ctau_JMuMu_J_Convolution_Tau_Value = -26.6;
	float ctau_JMuMu_J_Convolution_Mean_Value = -0.0032;
	float ctau_JMuMu_J_Convolution_Sigma_Value = 0.0032;
	float ctau_JMuMu_J_Gaus_Mean_Value = 0.00061;
	float ctau_JMuMu_J_Gaus_Sigma_Value = 0.00099;
	float ctau_JMuMu_J_Frac_Value = 0.097;

	//For JMuMu on the ctau(MuMu) dimension 
	float ctau_JMuMu_MuMu_Convolution_Tau_Value = -22.6;
	float ctau_JMuMu_MuMu_Convolution_Mean_Value = -0.0064;
	...
	float FourMuonMass_HighCut = 45;
	float DeltaY_LowCut = 0.0;
	float DeltaY_HighCut = 3.0;
	...
	RooRealVar J_Mean("J_Mean", "J_Mean", J_Mass, J_Mass - 1E-2, J_Mass + 1E-2);  //1

	RooRealVar J_Sigma1("J_Sigma1", "J_Sigma1", 0.02, 0.01, 0.08);                //2
	RooRealVar J_Sigma2("J_Sigma2", "J_Sigma2", 0.04, 0.02, 0.08);                //3

	RooRealVar J_Alpha("J_Alpha", "J_Alpha", 3, 0, 5);                            //4
	RooRealVar J_N("J_N", "J_N", 2, 0, 3);                                        //5

	RooRealVar J_Frac("J_Frac", "J_Frac", 0.5, 0, 1);                             //6
	...
	*/
	...
	J1_Canvas->SaveAs("J1_Result.pdf");
	...
	*/
	...
	J2_Canvas->SaveAs("J2_Result.pdf");
	...
	*/
	...
	ctau1_Canvas->SaveAs("ctau1_Result.pdf");
	...
	*/
	...
	ctau2_Canvas->SaveAs("ctau2_Result.pdf");
