...
void Fit_Final(float FourMuonMass_LowCut_Value, float FourMuonMass_HighCut_Value, float DeltaY_LowCut_Value, float DeltaY_HighCut_Value, int YNumber, int MassNumber, TString Output_Name) {
	...
	float J_Mean_Value = 3.09305;
	float J_Sigma1_Value = 0.0230;
	float J_Sigma2_Value = 0.0557;
	float J_Alpha_Value = 2.84;
	float J_N_Value = 0.75;
	float J_Frac_Value = 0.656;
	...
	float DeltaY_LowCut = DeltaY_LowCut_Value;
	float DeltaY_HighCut = DeltaY_HighCut_Value;
	...
	*/
	...
	OutputNumber = OutputNumber + YNumber + MassNumber;
	...
	*/
	...
	fprintf(OutputFile, "(%i, %i): %i\n", YNumber, MassNumber, FitResult->status());
