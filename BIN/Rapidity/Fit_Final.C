...
void Fit_Final(float DeltaY_LowCut_Value, float DeltaY_HighCut_Value, int YNumber, TString Output_Name) {
	...
	//Bin cut
	float FourMuonMass_LowCut = 0;
	float FourMuonMass_HighCut = 0;
	...
	*/
	...
	OutputNumber = OutputNumber + YNumber;
